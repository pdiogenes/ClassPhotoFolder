...
import com.example.classphotofolder.CalendarEvent;
	...
	public static void readCalendar(Context context, int days, int hours) {
		...
		for (String id : calendarIds) {
	        ...
	        if(eventCursor.getCount()>0)
	        {
	            ...
	            // Create an object of com.example.classphotofolder.CalendarEvent which contains the title, when the event begins and ends,
